...
library(ggpubr)
getwd()
setwd("D:/R_work/Using-R-for-Visualizing/met_pic_output")
...
#要做显著性检验的组
my_comparisons <- list( c("0mM LG","10mM LG"), c("10mM LG","10mM LG + 20uM A9"),c("1mM LG","1mM LG + 20uM A9"),
                     c("10mM LG","2.5mM LG"),c("2.5mM LG","2.5mM LG + 20uM A9"))
